...
public abstract class Menu {
    ...
    private boolean checkGlitch = true;
    private boolean updateInRunnable = false;
    ...
    public void openMenu(final Player player) {
        ...
        Map<Integer, Button> map = new HashMap<>(this.buttons);

        for (Map.Entry<Integer, Button> buttonEntry : map.entrySet()) {
        ...
        if (this.isPlaceholder()) {
            for (int index = 0; index < size; index++) {
                if (map.get(index) == null) {
                    map.put(index, this.placeholderButton);
